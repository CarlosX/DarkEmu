...
private:
	...
	void OnRequestInformation_Server		(PacketContainer* packet);
	void OnRequestInformation_Download		(PacketContainer* packet);

	void OnRequestNews						(PacketContainer* packet);
	void OnRequestServerList				(PacketContainer* packet);

	void OnAuthentication					(PacketContainer* packet);
};
