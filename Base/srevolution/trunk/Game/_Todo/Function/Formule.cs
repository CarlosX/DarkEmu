...
namespace SrxRevo
{
    public class Formule
    {
        ...
        public static double gamedistance(SrxRevo.character._pos p1, SrxRevo.character._pos p2)
        ...
        public static double gamedistance(obj p1, SrxRevo.character._pos p2)
        {  // Nukei: for test with range checking on objects, maybe faster than only calculating distance
            if ((p1.xSec >= p2.xSec - 1) && (p1.xSec <= p2.xSec + 1) && (p1.ySec >= p2.ySec - 1) && (p1.ySec <= p2.ySec + 1))
            {
        ...
        public static double gamedistance(spez_obj p1, SrxRevo.character._pos p2)
        {  // Nukei: for test with range checking on objects, maybe faster than only calculating distance
            if ((p1.xSec >= p2.xSec - 1) && (p1.xSec <= p2.xSec + 1) && (p1.ySec >= p2.ySec - 1) && (p1.ySec <= p2.ySec + 1))
            {
                return gamedistance((float)p1.x, (float)p1.y, p2.x, p2.y);
        ...
        public static double gamedistance(world_item p1, SrxRevo.character._pos p2)
        {  // Nukei: for test with range checking on objects, maybe faster than only calculating distance
            if ((p1.xSec >= p2.xSec - 1) && (p1.xSec <= p2.xSec + 1) && (p1.ySec >= p2.ySec - 1) && (p1.ySec <= p2.ySec + 1))
            {
                return gamedistance((float)p1.x, (float)p1.y, p2.x, p2.y);
