            ...
            try
            {
                ...
                if (Character.Action.Target != 0)
                {
                    ...
                    if (distance >= 1)
                    {
                        ...
                        Send(Packet.Movement(new SrxRevo.Global.vektor(Character.Information.UniqueID,(float)Formule.packetx((float)item.x, item.xSec),(float)Character.Position.z,(float)Formule.packety((float)(float)item.y, item.ySec),Character.Position.xSec,Character.Position.ySec)));
            ...
            try
            {
                ...
                if (Character.Action.PickUping)
                {
                    ...
                    if (item.Model > 3)
                    {
                        ...
                        Send(Packet.MovementOnPickup(new SrxRevo.Global.vektor(Character.Information.UniqueID,
