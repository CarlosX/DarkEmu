    ...
    public partial class Systems
    {
                ...
                switch (type)
                {
                    case 1:
                        ...
                        if (Data.SkillBase[Character.Action.Skill.MainSkill].isAttackSkill)
                        {
                            ...
                            obj o = null;
                            if (Character.Action.Object != null && Character.Action.Object.GetType().ToString() == "SrxRevo.obj")
                            {
                            ...
                            if (o == null && Character.Action.Object != null && Character.Action.Object.GetType().ToString() == "SrxRevo.Systems")
                            {
        ...
        void ActionSkill()
        {
            try
            {
                ...
                else if (o == null && Character.Action.Object != null && Character.Action.Object.GetType().ToString() == "SrxRevo.Systems")
                ...
                for (byte f = 0; f < Character.Action.Skill.Found; f++)
                {
                    ...
                    else
                    {
                        if (target[f].sys != null && target[f].os == null) // player
                            SrxRevo.Effect.EffectMain(target[f].sys, Character.Action.Skill.MainSkill);

                        if (target[f].sys == null && target[f].os != null) // mob
                            SrxRevo.Effect.EffectMain(target[f].os, Character.Action.Skill.MainSkill);
                    }
                }
            ...
            try
            {
                if (!Character.Action.movementskill)
                {
                    ...
                    else
                    {
                        ...
                        float gamex = SrxRevo.Formule.gamex((float)x, xSec);
                        float gamey = SrxRevo.Formule.gamey((float)y, ySec);
