    ...
    public partial class Systems
    {
        ...
        public static void UpdateServerInfo(byte bStatus)
        {
            foreach (KeyValuePair<int, Systems.SRX_Serverinfo> LS in Systems.LSList)
            {
                try
                {
                    byte[] tBuf = Systems.IPC.PacketResponseServerInfo(Servers.IPCPort, bStatus, (UInt16)Systems.maxSlots, (UInt16)Systems.clients.Count, (UInt16)SrxRevo.Global.Versions.clientVersion);
        ...
        // Login user
        /////////////////////////////////////////////////////////////////////////////////
        public static int LoginUser(string aID, ref string aPass, ref SrxRevo.player aPlayer, bool localConnect)
        {
            MsSQL ms = new MsSQL("SELECT * FROM users WHERE password='" + cMD5.ConvertStringToMD5(aPass) + "'");
