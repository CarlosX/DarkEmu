...
namespace DarkEmu_GameServer
{
    class CLIENT_OPCODES
    {
        ...
        GAME_CLIENT_CHARACTER = 0x7216,
        GAME_CLIENT_CHAT = 0x77E3,
        GAME_CLIENT_INGAME_REQUEST = 0x7435,
    ...
    class SERVER_OPCODES
    {
        ...
        GAME_SERVER_CHARACTER = 0xB216,
        GAME_SERVER_CHARDATA = 0x30E6,
        GAME_SERVER_INGAME_ACCEPT = 0xB435,
        GAME_SERVER_LOADING_START = 0x359E,
        GAME_SERVER_LOADING_END = 0x34E6,
