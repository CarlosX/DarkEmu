...
namespace LoginServer
{
    public partial class Systems
    {
        ...
        {
            public UInt16 id = 0;
            public UInt16 port = 15779;
            public UInt16 ipcport = 15780;
            public UInt16 maxSlots = 0;
            ...
            try
            {
                if (File.Exists(Environment.CurrentDirectory + @"\Settings\" + serverFile))
                {
                    ...
                    else
                    {
                        ...
                        GServer.name = "[SRX] Default";
                        GServer.port = defaultPort;
                        GServer.ipcport = defaultPort;
                        GServer.code = "";
                ...
                else
                {
                    ...
                    GServer.name = "[SRX "+ Global.Versions.appVersion +"]";
                    GServer.port = defaultPort;
                    GServer.ipcport = defaultPort;
                    GServer.code = "";
                    GSList.Add(GServer.id, GServer);
