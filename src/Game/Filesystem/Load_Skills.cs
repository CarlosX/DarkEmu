    ...
    class Load_Skills
    {
        public static void LoadSkillData(string path)
        {
            ...
            for (int l = 0; l <= TxtFile.amountLine - 1; l++)
            {
                ...
                sd.SkillType = (s_data.SkillTypes)(byte)(TxtFile.commands[8]);
                sd.NextSkill = (Int32)(TxtFile.commands[9]);
                sd.CastingTimePhase1 = (Int32)(TxtFile.commands[11]);
                sd.CastingTimePhase2 = (Int32)(TxtFile.commands[12]);
                sd.CastingTimePhase3 = (Int32)(TxtFile.commands[13]);
                sd.CastingTime = sd.CastingTimePhase1 + sd.CastingTimePhase2 + sd.CastingTimePhase3;
                sd.reUseTime = (Int32)(TxtFile.commands[14]);
                sd.AttackTime = (Int32)(TxtFile.commands[15]);
                sd.Mastery = (Int16)(TxtFile.commands[34]);
                sd.SkillPoint = (Int32)(TxtFile.commands[46]);
                sd.Weapon1 = (byte)(TxtFile.commands[50]);
                sd.Weapon2 = (byte)(TxtFile.commands[51]);
                sd.Mana = (Int32)(TxtFile.commands[53]);
                sd.tmpProp = (Int32)(TxtFile.commands[75]);
                sd.AmountEffect = 0;
                sd.AttackCount = (Int32)(TxtFile.commands[77]);
                ...
                try
                {
                    while ((skillInfo = (Int32)(TxtFile.commands[propIndex])) != 0 && !effectEnd)
                    {
                        propIndex++;
                        ...
                        switch (nameString)
                        {
                            ...
                            case null:
                                break;
                            case "setv":  //set value
                                string setvType = ASCIIIntToString((Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                ...
                                {   // warrior
                                    ...
                                    case "HLRU": // HP recovery % Inrease
                                        sd.Properties1.Add(setvType, (Int32)(TxtFile.commands[propIndex]));
                                        propIndex++;
                                        break;
                                    // cleric
                                    case "HLFS": // charity
                                    ...
                                    case "HLSM": // charity
                                        sd.Properties1.Add(setvType, (Int32)(TxtFile.commands[propIndex]));
                                        propIndex++;
                                        sd.Properties2.Add(setvType, (Int32)(TxtFile.commands[propIndex]));
                                        propIndex++;
                            ...
                            case "dcri": // critical parry inc
                                sd.Properties1.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            // 2 properties
                            case "mc":
                            ...
                            case "curt": // negative status effect reduce target player
                                sd.Properties1.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                sd.Properties2.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            // 3 properties
                            ...
                            case "cnsm": // consume item
                                ...
                                sd.Properties2.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                sd.Properties3.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            // 4 properties
                            case "csit": // division
                            ...
                            case "summ": // summon bird
                                ...
                                sd.Properties3.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                sd.Properties4.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            // 5 properties
                            case "bl": // bleed
                                ...
                                sd.Properties4.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                sd.Properties5.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            // 6 properties
                            case "cshp": // panic
                            case "csmp": // combustion
                                ...
                                sd.Properties5.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                sd.Properties6.Add(nameString, (Int32)(TxtFile.commands[propIndex]));
                                propIndex++;
                                break;
                            case "reqi": // required item
                                int weapType1 = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                int weapType2 = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                            ...
                            case "ssou": // summon monster
                                ...
                                while ((Int32)(TxtFile.commands[propIndex]) != 0)
                                {
                                    summon = new s_data.summon_data();
                                    summon.ID = (Int32)(TxtFile.commands[propIndex]);
                                    propIndex++;
                                    summon.Type = (byte)(TxtFile.commands[propIndex]);
                                    propIndex++;
                                    summon.MinSummon = (byte)(TxtFile.commands[propIndex]);
                                    propIndex++;
                                    summon.MaxSummon = (byte)(TxtFile.commands[propIndex]);
                                    propIndex++;
                            ...
                            case "att": // if attack skill
                                ...
                                sd.Time = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                sd.MagPer = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                sd.MinAttack = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                sd.MaxAttack = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                sd.PhyPer = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                break;
                            case "efr":
                                sd.efrUnk1 = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                int type2 = (Int32)(TxtFile.commands[propIndex]);
                                if (type2 == 6)
                                ...
                                sd.Distance = (Int32)(TxtFile.commands[propIndex]); // in decimeters
                                propIndex++;
                                sd.SimultAttack = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                int unk2 = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                int unk3 = (Int32)(TxtFile.commands[propIndex]);
                                propIndex++;
                                break;
                            default:
                ...
                #region Information
                /*
                sd.EffectLvl1 = (Int32)(TxtFile.commands[82]);
                if (sd.ID == 3977)
                    Console.WriteLine("{0}", sd.Properties2);
                if((Int64)(TxtFile.commands[78]) < 255) sd.eLevel = (byte)(TxtFile.commands[78]);
                if (ID == 3639)
                {
