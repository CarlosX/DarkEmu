            ...
            try
            {
                if (this.Type == 3)
                {
                    ...
                    #region Tiger Girl
                        if (this.ID == 1954)
                        {
                            SrxRevo.GlobalUnique.Tiger = false;
                        }
                    #endregion
                    #region Cerberus
                        if (this.ID == 5871)
                        {
                            SrxRevo.GlobalUnique.Cerb = false;
                        }
                    #endregion
                    #region Captain ivy
                        if (this.ID == 14778)
                        {
                            SrxRevo.GlobalUnique.Ivy = false;
                        }
                    #endregion
                    #region Uruchi
                        if (this.ID == 1982)
                        {
                            SrxRevo.GlobalUnique.Uri = false;
                        }
                    #endregion
                    #region Isyutaru
                        if (this.ID == 2002)
                        {
                            SrxRevo.GlobalUnique.Isy = false;
                        }
                    #endregion
                    #region Lord Yarkan
                        if (this.ID == 3810)
                        {
                            SrxRevo.GlobalUnique.Lord = false;
                        }
                    #endregion
                    #region Demon Shaitan
                        if (this.ID == 3875)
                        {
                            SrxRevo.GlobalUnique.Demon = false;
                        }
                    #endregion
                }
            }
