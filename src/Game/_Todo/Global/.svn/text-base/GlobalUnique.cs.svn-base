            ...
            try
            {
                switch (o.ID)
                {
                    case 1954:
                        ...
                        Tiger = false;
                        SrxRevo.GlobalUnique.StartTGUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn tiger girl
                        break;
                    case 1982:
                        Systems.SendAll(Packet.Unique_Data(6, (int)1982, n.Information.Name));
                        Uri = false;
                        SrxRevo.GlobalUnique.StartUriUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn urichi
                        break;
                    case 2002:
                        Systems.SendAll(Packet.Unique_Data(6, (int)2002, n.Information.Name));
                        Isy = false;
                        SrxRevo.GlobalUnique.StartIsyUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn isy
                        break;
                    case 3810:
                        Systems.SendAll(Packet.Unique_Data(6, (int)3810, n.Information.Name));
                        Lord = false;
                        SrxRevo.GlobalUnique.StartLordUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn lord yarkan
                        break;
                    case 3875:
                        Systems.SendAll(Packet.Unique_Data(6, (int)3875, n.Information.Name));
                        Demon = false;
                        SrxRevo.GlobalUnique.StartDemonUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn demon shaitan
                        break;
                    case 3877:
                        Systems.SendAll(Packet.Unique_Data(6, (int)3877, n.Information.Name));
                        Roc_s = false;
                        SrxRevo.GlobalUnique.StartRoc(rnd.Next(10, 20) * 60000, 600);   //Random spawn roc
                        break;
                    case 5871:
                        Systems.SendAll(Packet.Unique_Data(6, (int)5871, n.Information.Name));
                        Cerb = false;
                        SrxRevo.GlobalUnique.StartCerbUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn cerberus
                        break;
                    case 14778:
                        Systems.SendAll(Packet.Unique_Data(6, (int)14538, n.Information.Name));
                        Ivy = false;
                        SrxRevo.GlobalUnique.StartIvyUnique(rnd.Next(10, 20) * 60000, 600);   //Random spawn captain ivy
                        break;
                    case 14839:
                        Systems.SendAll(Packet.Unique_Data(6, (int)22654, n.Information.Name));
                        Cerb = false;
                        SrxRevo.GlobalUnique.StartMedusa(rnd.Next(10, 20) * 90000, 600);   //Random spawn medusa
                        break;
                    case 32768:
                        Systems.SendAll(Packet.Unique_Data(6, (int)32768, n.Information.Name));
                        Neith_s = false;
                        SrxRevo.GlobalUnique.StartNeith(rnd.Next(10, 20) * 90000, 600);   //Random spawn neith
                        break;
                    case 32752:
                        Systems.SendAll(Packet.Unique_Data(6, (int)32752, n.Information.Name));
                        Sphinx_s = false;
                        SrxRevo.GlobalUnique.StartSphinx(rnd.Next(10, 20) * 90000, 600);   //Random spawn sphinx
                        break;
                    case 32770:
                        Systems.SendAll(Packet.Unique_Data(6, (int)32770, n.Information.Name));
                        Isis_s = false;
                        SrxRevo.GlobalUnique.StartIsis(rnd.Next(10, 20) * 90000, 600);   //Random spawn isis
                        break;
                }
            }
            catch (Exception ex)
