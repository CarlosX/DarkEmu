...
namespace SrxRevo
{
    public partial class Systems
    {
        ...
        void GM_SPAWN_UNIQUE()
        {
            ...
            SrxRevo.GlobalUnique.StartTGUnique(0, 0);          //Random spawn tiger girl
            SrxRevo.GlobalUnique.StartUriUnique(0, 0);         //Random spawn urichi
            SrxRevo.GlobalUnique.StartIsyUnique(0, 0);         //Random spawn isy
            SrxRevo.GlobalUnique.StartLordUnique(0, 0);        //Random spawn lord yarkan
            SrxRevo.GlobalUnique.StartDemonUnique(0, 0);       //Random spawn demon shaitan
            SrxRevo.GlobalUnique.StartCerbUnique(0, 0);        //Random spawn cerberus
            SrxRevo.GlobalUnique.StartIvyUnique(0, 0);       //Random spawn captain ivy
            SrxRevo.GlobalUnique.StartMedusa(0, 0);            //Random spawn medusa
            SrxRevo.GlobalUnique.StartIsis(0, 0);            //Random spawn medusa
            //Game.GlobalUnique.StartSphinx(0, 0);            //Random spawn medusa
            SrxRevo.GlobalUnique.StartNeith(0, 0);            //Random spawn medusa
        ...
        void GM_WP(byte xSec, byte ySec, float x, float z, float y)
        {
            ...
            Character.Position.x = SrxRevo.Formule.gamex(x,xSec);
            Character.Position.z = z;
            Character.Position.y = SrxRevo.Formule.gamey(y,ySec);
            //Required
